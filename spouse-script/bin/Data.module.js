var data = {
    system: {
        "Kitten Plushie": {
            ...
            "type": "Plushie",
            "price": 50,
            "img-src": "https://www.torn.com/images/items/215/large.png",
            "target": 0
        },
        "Sheep Plushie": {
            "location": "City",
            "type": "Plushie",
            "price": 25,
            "img-src": "https://www.torn.com/images/items/186/large.png",
            "target": 0
        },
        "Teddy Bear Plushie": {
            "location": "City",
            "type": "Plushie",
            "price": 30,
            "img-src": "https://www.torn.com/images/items/187/large.png",
            "target": 0
        },
        "Jaguar Plushie": {
            "location": "Mexico",
            "type": "Plushie",
            "price": 10000,
            "img-src": "https://www.torn.com/images/items/258/large.png",
            "target": 0
        },
        "Dahlia": {
            "location": "Mexico",
            "type": "Flower",
            "price": 300,
            "img-src": "https://www.torn.com/images/items/260/large.png",
            "target": 0
        },
        "Wolverine Plushie": {
            "location": "Canada",
            "type": "Plushie",
            "price": 30,
            "img-src": "https://www.torn.com/images/items/261/large.png",
            "target": 0
        },
        "Crocus": {
            "location": "Canada",
            "type": "Flower",
            "price": 600,
            "img-src": "https://www.torn.com/images/items/263/large.png",
            "target": 0
        },
        "Banana Orchid": {
            ...
            "type": "Flower",
            "price": 4000,
            "img-src": "https://www.torn.com/images/items/617/large.png",
            "target": 0
        },
        "Stingray Plushie": {
            "location": "Cayman Islands",
            "type": "Plushie",
            "price": 400,
            "img-src": "https://www.torn.com/images/items/618/large.png",
            "target": 0
        },
        "Orchid": {
            "location": "Hawaii",
            "type": "Flower",
            "price": 700,
            "img-src": "https://www.torn.com/images/items/264/large.png",
            "target": 0
        },
        "Heather": {
            "location": "UK",
            "type": "Flower",
            "price": 5000,
            "img-src": "https://www.torn.com/images/items/267/large.png",
            "target": 0
        },
        "Nessie Plushie": {
            "location": "UK",
            "type": "Plushie",
            "price": 200,
            "img-src": "https://www.torn.com/images/items/266/large.png",
            "target": 0
        },
        "Red Fox Plushie": {
            "location": "UK",
            "type": "Plushie",
            "price": 1000,
            "img-src": "https://www.torn.com/images/items/268/large.png",
            "target": 0
        },
        "Ceibo Flower": {
            "location": "Argentina",
            "price": 500,
            "type": "Flower",
            "img-src": "https://www.torn.com/images/items/271/large.png",
            "target": 0
        },
        "Monkey Plushie": {
            "location": "Argentina",
            "type": "Plushie",
            "price": 400,
            "img-src": "https://www.torn.com/images/items/269/large.png",
            "target": 0
        },
        "Edelweiss": {
            ...
            "type": "Flower",
            "price": 900,
            "img-src": "https://www.torn.com/images/items/272/large.png",
            "target": 0
        },
        "Chamois Plushie": {
            "location": "Switzerland",
            "type": "Plushie",
            "price": 400,
            "img-src": "https://www.torn.com/images/items/273/large.png",
            "target": 0
        },
        "Cherry Blossom": {
            "location": "Japan",
            "type": "Flower",
            "price": 500,
            "img-src": "https://www.torn.com/images/items/277/large.png",
            "target": 0
        },
        "Panda Plushie": {
            "location": "China",
            "type": "Plushie",
            "price": 400,
            "img-src": "https://www.torn.com/images/items/274/large.png",
            "target": 0
        },
        "Peony": {
            "location": "China",
            "type": "Flower",
            "price": 5000,
            "img-src": "https://www.torn.com/images/items/276/large.png",
            "target": 0
        },
        "Camel Plushie": {
            "location": "UAE",
            "type": "Plushie",
            "price": 14000,
            "img-src": "https://www.torn.com/images/items/384/large.png",
            "target": 0
        },
        "Tribulus Omanense": {
            "location": "UAE",
            "type": "Flower",
            "price": 6000,
            "img-src": "https://www.torn.com/images/items/385/large.png",
            "target": 0
        },
        "Lion Plushie": {
            ...
            "type": "Plushie",
            "price": 400,
            "img-src": "https://www.torn.com/images/items/281/large.png",
            "target": 0
        },
        "African Violet": {
            "location": "South Africa",
            "type": "Flower",
            "price": 2000,
            "img-src": "https://www.torn.com/images/items/282/large.png",
            "target": 0
        }
    },
    controls: [
...
<g data-type="control" data-value="locations" >
    ...
    locations: [
        { value: "Mexico", icon: "" },
        { value: "Canada", icon: "" },
        { value: "Cayman Islands", icon: "" },
        { value: "Hawaii", icon: "" },
        { value: "Argentina", icon: "" },
        { value: "United Kingdom", icon: "" },
    ...
    types: [
        { value: "Plushie", icon: "" },
        { value: "Flower", icon: "" },
        { value: "Temporary", icon: "" },
        { value: "Drug", icon: "" },
        { value: "Booster", icon: "" },
    ],
    _filterDefault: [
        { type: "location", value: "Mexico" },
        { type: "location", value: "Canada" },
        { type: "location", value: "Cayman Islands" },
        { type: "location", value: "Hawaii" },
        { type: "location", value: "Argentina" },
        { type: "location", value: "United Kingdom" },
        { type: "location", value: "Switzerland" },
        { type: "location", value: "Japan" },
        { type: "location", value: "China" },
        { type: "location", value: "UAE" },
        { type: "location", value: "South Africa" },
        { type: "type", value: "Plushie" },
        { type: "type", value: "Flower" },
        { type: "type", value: "Temporary" },
    ...
    */
    ...
    async _check() {
        if (this.key) {
            log("%cCHECK - key = %s", logStyle, this.key);
            //CHECK USER
            if (this.user) {
                log("%cCHECK - USER = %o", logStyle, this.user);
                const jsonuser = await JSON.parse(this.user);
                if (jsonuser.error) {
                    log("%cLOCAL USER HAS ERRORS");
                    this.user = false;
                    const _newUserData = await this.fetchPlayer(this.key);
                    this.user = _newUserData;
                    this.set(this.userkey, _newUserData);
                } else if (Date.now() - (jsonuser.timestamp * 1000) > 3600000) {
                    log("%cLOCAL USER IS OLD");
                    this.user = false;
                    const _newUserData = await this.fetchPlayer(this.key);
                    this.user = _newUserData;
                    this.set(this.userkey, _newUserData);
                } else {
                    log("%cLOCAL USER IS VALID AND IN DATE");
                    this.user = jsonuser;
                }
            } else {
                log("%cCHECK - NO USER PRESENT", logStyle);
                this.user = false;
                const _newUserData = await this.fetchPlayer(this.key);
                this.user = _newUserData;
                this.set(this.userkey, _newUserData);
            ...
            // CHECK SPOUSE
            if (this.spouse) {
                log("%cCHECK - SPOUSE = %o", logStyle, this.spouse);
                const jsonspouse = await JSON.parse(this.spouse);
                if (jsonspouse.error) {
                    log("%cLOCAL SPOUSE HAS ERRORS");
                    this.spouse = false;
                    const _newSpouseData = await this.fetchPlayer(this.key, this.user.married.spouse_id);
                    this.spouse = _newSpouseData;
                    this.set(this.spousekey, _newSpouseData);
                } else if (Date.now() - (jsonspouse.timestamp * 1000) > 3600000) {
                    log("%cLOCAL SPOUSE IS OLD");
                    this.spouse = false;
                    const _newSpouseData = await this.fetchPlayer(this.key, this.user.married.spouse_id);
                    this.spouse = _newSpouseData;
                    this.set(this.spousekey, _newSpouseData);
                } else {
                    log("%cLOCAL SPOUSE IS VALID AND IN DATE");
                    this.spouse = jsonspouse;
                }
            } else {
                log("%cCHECK - NO SPOUSE PRESENT", logStyle);
                this.spouse = false;
                const _newSpouseData = await this.fetchPlayer(this.key, this.user.married.spouse_id);
                this.spouse = _newSpouseData;
                this.set(this.spousekey, _newSpouseData);
            ...
            // CHECK FILTERS
            if (this.filters) {
                log("%cCHECK - FILTERS = %o", logStyle, this.filters); // is array dont do anything
            } else {
                log("%cCHECK - NO FILTERS PRESENT", logStyle);
                this.filters = this._filterDefault;
            };
        } else {
            log("%cCHECK - NO KEY PRESENT", logStyle);
            this.key = false;
        };
    }
};
